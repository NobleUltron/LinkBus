      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="modal-modern absolute right-0 z-40 mt-2 w-[22rem] overflow-hidden rounded-2xl border border-line bg-surface shadow-2xl"
          >
            {/* Header */}
            ...
            {/* Notification List */}
            <div className="thin-scroll max-h-84 overflow-y-auto">
              {notifications.length === 0 ? (
