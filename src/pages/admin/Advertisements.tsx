...
export function Advertisements() {
  ...
  const fields: FieldConfig[] = [
    ...
    {
      name: 'image_url',
      label: 'Creative Image / Banner Banner URL',
      type: 'url',
      required: true,
      span: 2,
      placeholder: 'https://images.unsplash.com/photo-...',
      hint: 'Wide landscape banner crops (1200x500 or 16:9) work best across all passenger screen resolutions.',
    },
    {
      name: 'link_url',
      label: 'Call to Action Target Link',
      required: true,
      placeholder: '/search?destination=2',
      hint: 'Can be an internal route like /search or /services, or an external promotional page.',
    },
    {
      name: 'type',
