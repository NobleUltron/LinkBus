...
export function Login() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-app text-fg selection:bg-brand-500/20 lg:grid lg:grid-cols-[1.1fr_1.25fr]">
      ...
      {/* ═══════════════════════════════════════════════════════════════════
         ...
         ═══════════════════════════════════════════════════════════════════ */}
      <div className="relative hidden overflow-hidden bg-slate-950 lg:flex lg:flex-col lg:justify-between p-12 lg:p-14">
