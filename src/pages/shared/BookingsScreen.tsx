  ...
  const renderMobileBookingCard = (booking: BookingDetail) => {
    ...
    return (
      <div className="p-4 bg-surface hover:bg-surface-2/60 transition-colors space-y-3">
        {/* Top row: Booking Ref, Round Trip badge, Date, Status */}
        <div className="flex items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-1.5 min-w-0">
            ...
            {booking.linked_booking && (
              <span className="inline-flex items-center rounded bg-purple-500/15 border border-purple-500/30 px-1.5 py-0.5 text-[0.625rem] font-bold text-purple-700 dark:text-purple-300">
                Round Trip
              </span>
            )}
        ...
        <div className="flex flex-wrap items-center justify-end gap-1.5 pt-2 border-t border-line/50">
          ...
          <button
            ...
            title="Share on WhatsApp"
            className="min-h-[38px] inline-flex items-center gap-1 rounded-xl border border-line bg-surface px-2.5 py-1.5 text-xs font-semibold text-muted hover:text-emerald-600 hover:bg-emerald-500/10 active:scale-95 transition-all"
          >
            <MessageSquareIcon className="h-3.5 w-3.5 text-emerald-600" aria-hidden />
            <span className="hidden xs:inline text-[0.6875rem]">WhatsApp</span>
          </button>
          ...
          <button
            ...
            title="View Receipt"
            className="min-h-[38px] inline-flex items-center gap-1 rounded-xl border border-line bg-surface px-2.5 py-1.5 text-xs font-semibold text-muted hover:text-fg hover:bg-surface-2 active:scale-95 transition-all"
          >
            <ReceiptTextIcon className="h-3.5 w-3.5" aria-hidden />
            <span className="hidden xs:inline text-[0.6875rem]">Receipt</span>
          </button>
